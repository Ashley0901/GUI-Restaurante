...
def total():
    ...
    subtotal = sub_total_comida + sub_total_postre + sub_total_bebidas
...
#quitar la opcion de agrandar pantalla
...
#lista_productos
lista_comidas = ['pollo','salmón','pescado','pizza','hamburguesa','filete','lasaña','langosta']
lista_bebidas = ['refresco','agua','cerveza','vino','mezcal','jugo','malteada','agua de sabor']
lista_postres = ['flan','pastel','fruta','natilla','dona','cheescake','chocolatin','hot cake']
...
etiqueta_costo_bebida = Label(panel_costos,text = 'Costo bebida', font=('Dosis',12,'bold'),
                              bg = 'azure4',fg ='white')
...
etiqueta_costo_postre = Label(panel_costos,text = 'Costo postre', font=('Dosis',12,'bold'),
                              bg = 'azure4',fg ='white')
...
etiqueta_impuestos = Label(panel_costos,text = 'Impuestos', font=('Dosis',12,'bold'),
                              bg = 'azure4',fg ='white')
...
for boton in botones:
    boton = Button(panel_botones,text = boton.title(),font = ('Dosis',14,'bold'),fg = 'white',
...
texto_recibo = Text(panel_recibo,font = ('Dosis',13,'bold'),bd=1,width = 51,height = 10)
texto_recibo.grid(row = 0,column = 0)


#calculadora
visor_calculadora=Entry(panel_calculadora,font = ('Dosis',16,'bold'), width= 32,
                        bd = 1)
...
#loop para no cerrar nunca la ventana
aplicacion.mainloop()
